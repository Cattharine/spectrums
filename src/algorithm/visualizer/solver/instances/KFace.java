...
public class KFace {
    ...
    private Vertex fBest;
    private Vertex sBest;
    ...
    public Path getPath() {
        if (sBest != null && fBest != null)
            return new Path(name.toString(), fBest.getPos(), sBest.getPos());
        else return new Path(name.toString(), -1, -1);
    }
